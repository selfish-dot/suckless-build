...
const char *spcmd2[] = {"st", "-n", "news", "-g", "120x34", "-e", "newsboat", NULL };
const char *spcmd3[] = {"st", "-n", "mus", "-g", "120x34", "-e", "cmus", NULL };
...
static const Rule rules[] = {
	...
	{ NULL,		  "news",	NULL,		SPTAG(1),	1,	    0,		0, 		-1 },
	{ NULL,		  "mus", 	NULL,		SPTAG(2),	1,	    0,		0, 		-1 },
};
